#ifndef PREMIUM_DECORATOR_H_
#define PREMIUM_DECORATOR_H_
 ...
 */
class PremiumDecorator : public IPkgDecorator {
 public:
  /**
   ...
   */
  PremiumDecorator(Package* pkg, Drone* drone);
};

#endif  // PREMIUM_DECORATOR_H_
