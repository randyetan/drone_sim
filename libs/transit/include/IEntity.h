...
class IEntity {
  ...
  */
  ...
  /**
  * @brief Gets the amount of money the entity has
  * @return Float that is the money the entity has.
  */
  virtual float getMoney() const;

  /**
  * @brief Sets the amount of money an entity should have
  * @param bal_ The new balance the entity has
  */
  virtual void setMoney(float bal_);

  /**
   * @brief Sets the speed of the entity.
   * @param speed_ Used to set new speed
   */
